...
final class WikiRuntimeDefaultsScenarioTests: XCTestCase {
  ...
  func testRuntimeDefaultsInstallAndRenderCurrentContract() throws {
    ...
    try proveConfiguredCustomPageRenders(lab: lab, defaultsRoot: defaultsRoot, engine: engine, repo: repo)
  }
  ...
  private func proveConfiguredCustomPageRenders(lab: URL, defaultsRoot: URL, engine: URL, repo: URL) throws {
    ...
    wikiConfig += """
      ...
      summary = "Runtime-test custom page created from the context-page template."
      nav_order = 900
      """
  ...
  private func scenarioRoot(repo: URL) -> URL {
    ...
    return repo.appendingPathComponent("runtime-test/wiki-runtime-current-contract", isDirectory: true)
  }
