...
final class UpdateCheckerTests: XCTestCase {
  func testCachedUpdateStateReportsAvailableUpdate() throws {
    ...
    try Data("""
    {
      ...
      "last_seen_latest": "0.1.30",
      "notes_url": "https://github.com/hapticasensorics/1context/releases/tag/v0.1.30"
    }
    ...
    XCTAssertEqual(cached?.latest?.version, "0.1.30")
    XCTAssertEqual(cached?.latest?.notesURL?.absoluteString, "https://github.com/hapticasensorics/1context/releases/tag/v0.1.30")
