...
ensure_runtime_dirs() {
  mkdir -p \
    ...
    "$RUNTIME_TEST/1Context/context-engine/orchestrators/wiki-company-orchestrator-v1" \
    "$RUNTIME_TEST/1Context/context-engine/agents/directory" \
    "$RUNTIME_TEST/1Context/context-engine/agents/harness" \
    "$RUNTIME_TEST/1Context/context-engine/agents/policies" \
    "$RUNTIME_TEST/1Context/context-engine/mail/mailboxes" \
    "$RUNTIME_TEST/1Context/context-engine/mail/threads" \
