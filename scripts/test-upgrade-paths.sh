...
require_file "$ROOT/scripts/classify-release-lockdown-diagnostics.py"
require_file "$ROOT/scripts/test-release-lockdown-diagnostics.sh"
...
python3 -m py_compile "$ROOT/scripts/classify-release-lockdown-diagnostics.py"
