...
grep -q "run_signed_publish:" "$ROOT/.github/workflows/release.yml"
grep -q "run_self_hosted_proof:" "$ROOT/.github/workflows/release.yml"
grep -q "default: false" "$ROOT/.github/workflows/release.yml"
grep -q 'if: ${{ inputs.run_signed_publish }}' "$ROOT/.github/workflows/release.yml"
grep -q 'if: ${{ !inputs.run_signed_publish }}' "$ROOT/.github/workflows/release.yml"
grep -q 'if: ${{ inputs.run_signed_publish && startsWith(github.ref, '\''refs/tags/'\'') }}' "$ROOT/.github/workflows/release.yml"
grep -q "run_self_hosted_proof requires run_signed_publish" "$ROOT/.github/workflows/release.yml"
