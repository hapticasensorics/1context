 ...
 * - Right rail: 4 fixed icons (account, search, bookmark, customize).
...
(() => {
  ...
  /* =============================================================
   * Right rail — 4 icons fixed on the right edge
   * ============================================================= */
    ...
    fetch(mdHref)
      ...
      .then((md) => {
        ...
        const corpusSurfaces = [
          { label: '/llms.txt',       url: '/llms.txt',       status: 'planned', note: 'Curated index of authored docs' },
          { label: '/llms-full.txt',  url: '/llms-full.txt',  status: 'planned', note: 'Full corpus, project-authored, partitioned from imported reference' },
          { label: '/docs-index.json', url: '/docs-index.json', status: 'planned', note: 'Machine manifest — every page\'s frontmatter as structured fields' },
        ];
...
<span class="opctx-agent-snippet-planned">await mcp.call('1context__read_page', { slug: ${JSON.stringify(slug)}, format: 'md' });</span></code></pre>
        ...
        article.innerHTML = `
          ...
          <section class="opctx-agent-section" id="agent-surfaces">
            ...
            <p class="opctx-agent-section-desc">The same content reached five ways. ✓ live = wired today. ⏳ planned = on the wiki runtime roadmap.</p>
