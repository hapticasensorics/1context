...
//
// Each group has a label + list of links. This is deliberately conservative
// until the menu is driven by wiki.toml; only shipped routes should appear here.
//
...
function renderBrandMenu(opts) {
  // Owner segment is empty by default → root-relative URLs (`/your-context`).
  ...
  const groups = [
    {
      label: 'For You',
      items: [
        { href: `${ownerPrefix}/for-you`, label: 'For You', sub: 'Current orientation, recent signals, open loops' },
      ],
    },
    {
      label: 'Context',
